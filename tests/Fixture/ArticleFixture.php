...
class ArticleFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'article_category_id_fk' => ['type' => 'index', 'columns' => ['category_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'article_category_id_fk' => ['type' => 'foreign', 'columns' => ['category_id'], 'references' => ['category', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'created' => '2018-10-23 00:23:45',
            'modified' => '2018-10-23 00:23:45',
            'category_id' => 1
        ],
    ];
}
