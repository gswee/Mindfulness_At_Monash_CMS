...
class UsersController extends AppController
{
    ...
    public function edit($id = null)
    {
        ...
        //$pw = (new DefaultPasswordHasher)->hash($user->password);
    ...
    {
        $this->viewBuilder()->setLayout('admin');
        // Recent Articles Created / Modified
        $query = $this->Article->find();
    ...
    // Page for verifying email address to send Password reset email to email address
    public function password()
    {
        $this->viewBuilder()->setLayout('pwreset');
        if ($this->request->is('post')) {
